                        ...
                        <div class="category-menu">
                            <ul class="category-menu__list">
                                <li class="category-menu__list-item">
                                    <a href="sachthieunhi.php" target="_self" class="category-menu__list-item-link">Sách thiếu nhi</a>
                    ...
                    <div class="grid__col-10">
                        <div class="category-grid__head">
                            ...
                            <div class="scan">
                                ...
                                <div class="category-grid__head-sort">
                                    ...
                                    <select class="category-grid__head-select" name="sapxep">
                                        <option value="tang">Từ cao đến thấp</option>
                                        <option value="giam">Từ thấp đến cao</option>
                                    </select>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="home-product">
                            ...
                            <div class="grid__row">
                                ...
                                if(empty($search_name)) {
                                    ...
                                    $search_sql = "SELECT * FROM sach ORDER BY giatien DESC";
                        ...
                        <div class="grid__col-2-4">
                                ...
                                <div class="home-product__item">
                                        ...
                                        <div class="home-product__img-1">
                                            <img class="home-product__img" src="<?php echo './uploads/'.$value['anh']?>" alt="">
                                            <div class="home-product__opacity">
                                                
                                            </div>
                                            <a href="chitietsp.php<?php echo '?id='.$value['sach_id'];?>">
                                                <button class="home-product__button">
                                                    Xem sản phẩm <i class="fas fa-chevron-right" style="color: #fff; font-size: 18px; margin-left: 5px;"></i>
                                                </button>
                                            </a>
                                        </div>

                                        <div class="home-product__infor">
                                            <li class="home-product__name"><?php echo $value['ten'];?></li>
                                            <div class="home-product__infor-bot">
                                                <li class="home-product__name-tg"><?php echo $value['tacgia']?></li>
                                                <li class="home-product__price-new"><?php echo $value['giatien'].'<sup>vnd</sup>';?></li>
                                            </div>
                                        </div>
                                </div>
                            </div>
